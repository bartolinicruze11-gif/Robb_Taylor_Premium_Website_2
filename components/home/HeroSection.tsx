...
export default function HeroSection() {
  ...
  const bgOpacity = useTransform(scrollYProgress, [0, 0.7], [1, 0.12]);
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex flex-col overflow-hidden bg-[#020c18]">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none"
        style={{ background: 'linear-gradient(105deg, rgba(2,12,24,0.99) 0%, rgba(2,12,24,0.88) 35%, rgba(2,12,24,0.30) 75%, rgba(2,12,24,0.10) 100%)' }} />
      {/* Bottom fade */}
